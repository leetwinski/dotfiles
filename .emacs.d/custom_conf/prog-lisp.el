...
(use-package sly
  ...
  (setf sly-lisp-implementations
        '((sbcl    ("sbcl" "--dynamic-space-size" "1024"))
          (roswell ("ros" "dynamic-space-size=1024" "-L" "sbcl-bin/2.5.4" "-Q" "-l" "~/.sbclrc" "run"))))
  (setf sly-default-lisp 'roswell)
  (setf inferior-lisp-program "ros dynamic-space-size=1024 -L sbcl-bin/2.5.4 -Q -l ~/.sbclrc run"))
